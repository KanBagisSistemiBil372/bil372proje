...
<div class="jumbotron text-center">
    ...
    <form method="post">
        <div class="input-group">
            ...
            <input type="text" name="id" class="form-control" size="50" placeholder="Tc Kimlik Numarasi" required>
            <input type="text" name="phone" class="form-control" size="50" placeholder="Telefon numarasi" required>
            <input type="text" name="bloodtype" class="form-control" size="50" placeholder="Kan grubu" required>
            <input type="email" name="username" class="form-control" size="50" placeholder="Email Adresi" required>
            <input name="password" type="password" class="form-control" placeholder="Sifre"/>
            <div class="radio">
                <label><input type="radio" name="usertype" checked>Hasta</label>
            </div>
            <div class="radio">
                <label><input type="radio" name="usertype">Bagisci</label>
            </div>
